			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group form-inline">
						...
						<?php echo form_dropdown('status',$this->general_model->dropdown('permintaan_barang_status','Status'),set_value('status',(isset($row->status)?$row->status:'')),'required=required class="form-control input-sm select2" disabled="disabled"')?>
					</div>																						
				</div>
			</div>
		</div>
