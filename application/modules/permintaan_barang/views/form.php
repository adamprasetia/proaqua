			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group form-inline">
						...
						<?php echo form_dropdown('toko',$this->general_model->dropdown('toko','Toko'),set_value('toko',(isset($row->toko)?$row->toko:'')),'required=required class="form-control input-sm select2"')?>
						<small><?php echo form_error('toko')?></small>
					</div>																		
				</div>
			</div>
		</div>
