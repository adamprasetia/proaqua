...
-- Dumping structure for table proaqua.pengiriman_barang
...
-- Dumping data for table proaqua.pengiriman_barang: ~0 rows (approximately)
/*!40000 ALTER TABLE `pengiriman_barang` DISABLE KEYS */;
INSERT INTO `pengiriman_barang` (`id`, `nomor`, `tanggal`, `toko`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	(11, '001', '2016-07-30', '001', 16, '2016-07-30 16:24:53', 0, '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `pengiriman_barang` ENABLE KEYS */;


-- Dumping structure for table proaqua.pengiriman_barang_detail
CREATE TABLE IF NOT EXISTS `pengiriman_barang_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table proaqua.pengiriman_barang_detail: ~0 rows (approximately)
/*!40000 ALTER TABLE `pengiriman_barang_detail` DISABLE KEYS */;
INSERT INTO `pengiriman_barang_detail` (`id`, `id_parent`, `kode_barang`, `jumlah`, `keterangan`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	(56, 11, '001', 1200, 'asd', 16, '2016-07-30 16:24:53', 0, '0000-00-00 00:00:00'),
	(57, 11, '002', 1000, 'dsa', 16, '2016-07-30 16:24:53', 0, '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `pengiriman_barang_detail` ENABLE KEYS */;
...
-- Dumping data for table proaqua.produksi_barang_detail: ~2 rows (approximately)
...
-- Dumping structure for trigger proaqua.pengiriman_barang_after_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `pengiriman_barang_after_delete` AFTER DELETE ON `pengiriman_barang` FOR EACH ROW BEGIN
	DELETE from pengiriman_barang_detail where id_parent = OLD.id;
END//
DELIMITER ;
